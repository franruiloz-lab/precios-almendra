...
const FALLBACK_DATA = {
    ...
    murcia: {
        ...
        comuna:   [5.32, 5.42, 4.99, 4.92, 5.14, 5.08, 5.65, 5.50, 5.06, 5.01, 4.99, 4.99],
        marcona: [6.23, 6.31, 5.90, 5.86, 6.02, 6.04, 7.40, 7.25, 6.09, 6.06, 6.06, 6.06],
        largueta: [5.67, 5.75, 5.31, 5.29, 5.49, 5.49, 6.20, 6.05, 5.57, 5.50, 5.47, 5.47],
        guara:    [5.46, 5.56, 5.13, 5.06, 5.25, 5.20, 5.85, 5.70, 5.16, 5.11, 5.08, 5.09]
    },
    reus: {
        meses: ["May 25","Jun 25","Jul 25","Ago 25","Sep 25","Oct 25","Nov 25","Dic 25","Ene 26","Feb 26","Mar 26","Abr 26"],
    ...
    cordoba: {
        meses: ["May 25","Jun 25","Jul 25","Ago 25","Sep 25","Oct 25","Nov 25","Dic 25","Ene 26","Feb 26","Mar 26","Abr 26"],
        comuna:   [5.30, 5.30, 5.10, 5.00, 5.25, 5.10, 5.60, 5.45, 5.15, 5.15, 5.05, 5.05],
        marcona: [null, null, 6.90, null, null, null, 7.30, 7.15, null, null, null, null],
        largueta: [null, null, 5.70, null, null, null, 6.15, 6.00, null, null, null, null],
        guara:    [null, null, 5.30, 5.45, 5.46, 5.30, 5.80, 5.65, 5.35, 5.35, 5.25, 5.25]
    }
};
...
function getLastUpdate() {
    ...
    return '21 de mayo de 2026'; // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date // fallback date
}
