...
const FALLBACK_DATA = {
    ...
    murcia: {
        meses: ['Mar 25', 'Abr 25', 'May 25', 'Jun 25', 'Jul 25', 'Ago 25', 'Sep 25', 'Oct 25', 'Nov 25', 'Dic 25', 'Ene 26', 'Feb 26'],
        comuna:   [5.10, 5.05, 5.00, 4.95, 5.15, 5.70, 6.00, 5.80, 5.65, 5.50, 5.40, 5.45],
        marcona:  [6.90, 6.80, 6.75, 6.70, 7.00, 7.50, 7.80, 7.60, 7.40, 7.25, 7.10, 7.20],
        largueta: [5.70, 5.65, 5.60, 5.55, 5.75, 6.30, 6.60, 6.40, 6.20, 6.05, 5.95, 6.00],
        guara:    [5.30, 5.25, 5.20, 5.15, 5.35, 5.90, 6.20, 6.00, 5.85, 5.70, 5.60, 5.65]
    },
    reus: {
        meses: ['Mar 25', 'Abr 25', 'May 25', 'Jun 25', 'Jul 25', 'Ago 25', 'Sep 25', 'Oct 25', 'Nov 25', 'Dic 25', 'Ene 26', 'Feb 26'],
        comuna:   [5.30, 5.25, 5.20, 5.15, 5.35, 5.90, 6.20, 6.00, 5.85, 5.70, 5.60, 5.65],
        marcona:  [7.10, 7.00, 6.95, 6.90, 7.20, 7.70, 8.00, 7.80, 7.60, 7.45, 7.30, 7.40],
        largueta: [5.90, 5.85, 5.80, 5.75, 5.95, 6.50, 6.80, 6.60, 6.40, 6.25, 6.15, 6.20],
        guara:    [5.50, 5.45, 5.40, 5.35, 5.55, 6.10, 6.40, 6.20, 6.05, 5.90, 5.80, 5.85]
    },
    cordoba: {
        meses: ['Mar 25', 'Abr 25', 'May 25', 'Jun 25', 'Jul 25', 'Ago 25', 'Sep 25', 'Oct 25', 'Nov 25', 'Dic 25', 'Ene 26', 'Feb 26'],
        comuna:   [5.05, 5.00, 4.95, 4.90, 5.10, 5.65, 5.95, 5.75, 5.60, 5.45, 5.35, 5.40],
        marcona:  [6.80, 6.70, 6.65, 6.60, 6.90, 7.40, 7.70, 7.50, 7.30, 7.15, 7.00, 7.10],
        largueta: [5.65, 5.60, 5.55, 5.50, 5.70, 6.25, 6.55, 6.35, 6.15, 6.00, 5.90, 5.95],
        guara:    [5.25, 5.20, 5.15, 5.10, 5.30, 5.85, 6.15, 5.95, 5.80, 5.65, 5.55, 5.60]
    }
};
